...
function getLocation(x = [], y= [], nameoflocation = '') {
    ...
    setlong = y;
    if (nameoflocation != '') {
        alert('You have set your destination to '+  nameoflocation);
    }
...
function initMap() {
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        $('<p>').text("setReminder").appendTo();
        label_date = $('<p>').attr("id","label_date").appendTo(listelement.main);
        $('<p>').text(listelement.label).attr("id","label").appendTo(label_date);
        $('<p>').text(listelement.date).attr("id","date").appendTo(label_date);
        $('<p>').text(listelement.amount).attr("id","amount").appendTo(listelement.main);
        $(listelement.main).click(function () {
            showDetails(this);
            console.log('habe showdetails aufgerufen')
